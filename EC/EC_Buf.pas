...
uses Windows, SysUtils, Math, EC_File;
...
TBufEC = class(TObject)
    ...
    public
        ...
        procedure LoadFromFile(filename:PAnsiChar); overload;

        procedure SaveInFile(fa:TFileEC; plen:integer); overload;
        procedure SaveInFile(fa:TFileEC); overload;
        procedure SaveInFile(filename:PAnsiChar); overload;
end;
...
procedure TBufEC.LoadFromFile(filename:PAnsiChar);
var
    fa:TFileEC;
begin
    fa:=TFileEC.Create;
...
procedure TBufEC.SaveInFile(filename:PAnsiChar);
var
    fa:TFileEC;
begin
    fa:=TFileEC.Create;
